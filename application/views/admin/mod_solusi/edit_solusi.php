<div class="box-header with-border">
  <h3 class="box-title">Edit Solusi Penyakit</h3>
</div>
<form action="<?php echo base_url();?>Solusi/aksi_edit_solusi" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                 <textarea name="jenis_solusi" id="ck"><?php echo $jenis_solusi;?></textarea>
                </div>
              </div>
            </div>
                <br><br>
                ...
                <div class="box">
                  ...
                  <div class="box-body no-padding">
                    <table class="table table table-bordered table-hover" id="example2">
                      ...
                      <tr>
                         <td><input type="radio" name="kode_penyakit" value="<?php echo $p['kode'];?>" <?php if($p['kode'] == $penyakit_kode ) echo 'checked';?>></td>
